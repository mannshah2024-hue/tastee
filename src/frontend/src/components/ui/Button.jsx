...
/**
 * Button component with primary, secondary, ghost, destructive, and outline variants.
 */
const variantClasses = {
  primary:
    "bg-primary text-primary-foreground hover:bg-primary/90 shadow-elevated active:scale-[0.98]",
  secondary:
